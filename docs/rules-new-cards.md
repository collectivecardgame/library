...
## Rules for Submitting New Cards
...
### 3. No new cards which nullify core Collective mechanics
...
### 6. No cards with intentionally misleading text

For example, a unit which says "does nothing" but wins the game if unblocked.

### 7. Cards submitted must be made in the Collective in-game card editor

You cannot use outside image editing tools to create your own cards.

### 8. No cards using existing art
...
### 10. No cards that are designed around a feature that you'd like us to make
...
### 11. No references to the subreddit

This includes mentions of "upvotes," "karma," "meta," "reposts," "OC," etc.

### 12. No cards which violate lore
...
### 14. No cards which create infinite loops

If an infinite loop is created somehow, the game will draw. Cards which intentionally create infinite loops will not be allowed, and if cards can create infinite loops in combination with each other, we may have to change them if they become a meta staple. This is mostly because infinite loops will impact the performance of the game for all players.

### 15. No malicious posting of someone else's card
...
### 16. Developers do not have special privileges

The developers of this game, should they wish to add a card to the game, do not get any kind of special treatment. As you can see, [/u/NickCollective](https://old.reddit.com/user/NickCollective/submitted/?sort=top&t=year) (one of the developers) occasionally submits cards and is subject to the same restrictions as players.

## Temporary rules based on current game restrictions
...
5.  Change of control effects ("gain control of a unit" or "move a unit from your opponent's discard to your in play")
